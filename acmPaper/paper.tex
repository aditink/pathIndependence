...
Surprisingly, the optimal set algorithm cuts time cost by several orders of magnitude.
...
\begin{tabular}{|c|c|}
    \hline
    Algorithm & average seconds taken for ten nodes, density close to 0.5 \\
    \hline
