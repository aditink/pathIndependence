...
\ForEach{node v in V}{
    ...
    excludedEdges = edges in subgraph S - edges in T\;
...
\caption{Finding a spanning set of path pairs.}\label{algo_spanning_set}
\end{algorithm}
    ...
    \For{snk in existingGraph}{
        \try{}{
            ...
            FindPath(
                ...
                sinkNode: snk)\;
            \If{src == snk}{
                pathInOldGraph $\gets$ identity(src)\;
            }
            \Else(){
