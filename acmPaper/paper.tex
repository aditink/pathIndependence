...
These functions form a semigroup $F$, where multiplication is function composition.
...
Next, the \textit{path extraction algorithm} then transforms the output of the two flip path search into the verification set, $Q' \cup C'$.
