...
There are several examples of reasonably complicated transformation graphs that we can pick from.  Gator includes graphics examples as part of its examples package; for this evaluation, we looked at the \textit{phong}, \textit{reflection}, and \textit{shadow map} examples, sample images of which can be seen in Appendix~\ref{sec:gator-appendix}\xxx[as]{Either add text to appendix B or just reference a figure}.
